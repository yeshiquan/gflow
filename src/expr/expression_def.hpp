...
expression<Iterator>::expression(error_handler<Iterator> &error_handler)
    ...
    expr = logical_expr | condition_expr;

    condition_expr =
        lit("if") > logical_expr > logical_expr > lit("else") > logical_expr;
    ...
    primary_expr = uint_ | identifier | bool_ | '(' > expr > ')';

    identifier = !keywords >> raw[lexeme[(alpha | '_') >> *(alnum | '_')]];

    ///////////////////////////////////////////////////////////////////////
    // Debugging and error handling and reporting support.
    BOOST_SPIRIT_DEBUG_NODES((expr)(equality_expr)(relational_expr)(
        logical_expr)(additive_expr)(multiplicative_expr)(condition_expr)(
