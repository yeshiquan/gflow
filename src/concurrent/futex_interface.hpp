...
template <typename F>
inline Futex<F, typename std::enable_if_t<F::need_create()>>::Futex() :
    _value(F::create()) {
}

template <typename F>
inline Futex<F, typename std::enable_if_t<F::need_create()>>::Futex(const Futex& other) : Futex() {
    *_value = *other._value;
}

template <typename F>
inline Futex<F, typename std::enable_if_t<F::need_create()>>&
Futex<F, typename std::enable_if_t<F::need_create()>>::operator=(const Futex& other) {
    *_value = *other._value;
    return *this;
}

template <typename F>
inline Futex<F, typename std::enable_if_t<F::need_create()>>::~Futex() noexcept {
    F::destroy(_value);
}

template <typename F>
inline Futex<F, typename std::enable_if_t<!F::need_create()>>::Futex(uint32_t value) : _value(value) {
}

template <typename F>
inline Futex<F, typename std::enable_if_t<F::need_create()>>::Futex(uint32_t value) : Futex() {
    *_value = value;
}

template <typename F>
inline ::std::atomic<uint32_t>&
Futex<F, typename std::enable_if_t<!F::need_create()>>::value() noexcept {
...
Futex<F, typename std::enable_if_t<!F::need_create()>>::value() const noexcept {
...
template <typename F>
inline int Futex<F, typename std::enable_if_t<!F::need_create()>>::wait(
...
template <typename F>
inline int Futex<F, typename std::enable_if_t<!F::need_create()>>::wake_one() noexcept {
...
template <typename F>
inline int Futex<F, typename std::enable_if_t<!F::need_create()>>::wake_all() noexcept {
