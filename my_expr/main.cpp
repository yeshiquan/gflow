...
int main() {
  ...
  client::error_handler<iterator_type> error_handler(iter,
                                                     end);  // Our error handler
  client::parser::statement<iterator_type> parser(error_handler);  // Our parser
  client::code_gen::compiler compile(program, error_handler);  // Our compiler
